...
public final class MainFrame 
    ...
    public MainFrame() 
		...
		newStickyNote.addActionListener(new ActionListener() {
		...
		JMenuItem saveStickyNotes = Util.createJMenuItem(fFileMenu, StringDefs.SAVE_ALL_STICKY_NOTES, 'S', 0, null, this);
 	    saveStickyNotes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Stickies.saveNotes();
			}
		});
		...
		frontNotes.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
        ...
        backNotes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
